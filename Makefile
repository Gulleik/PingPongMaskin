...
SOURCE_FILES := main.c UART_driver.c XMEM_driver.c ADC_driver.c controller.c OLED.c OLED_interface.c SPI_communication_driver.c MCP_driver.c CAN_driver.c lib.c
